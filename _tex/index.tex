...
Hola Catalin We used simulated data representing urban population
growth, economic output, and ecological metrics over a 20-year period.
...
Our simulation\footnote{affsdflvaro} shows that moderate economic growth
can be sustained without significant ecological degradation, provided
that urban planning policies enforce green space and pollution controls.
Figures 1 and 2 illustrate the projected trends.
...
\textsubscript{Source:
\href{https://alvaro-alvarez-redondo.github.io/test-paper/index.qmd.html}{Article
Notebook}}
...
\citep{BASOLO2010} \citet{BASOLO2010}
